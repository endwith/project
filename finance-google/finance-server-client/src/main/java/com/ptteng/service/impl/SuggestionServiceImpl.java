...
private SuggestionMapper suggestionMapper;
    ...
    @Override
    public     long selectSuggeNoReadCount(Long id){
        return this.suggestionMapper.selectSuggeNoReadCount( id);
    }
    ...
    public Long selectCountWithCondition(Long id, String suggeContent, String adviser, String phone) {
        return this.selectCountWithCondition(id, suggeContent, adviser, phone);
    }
}