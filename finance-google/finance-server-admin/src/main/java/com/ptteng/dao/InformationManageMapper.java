...
public interface InformationManageMapper {
    ...
    List<InformationManage> select(@Param("a") Long a, @Param("b") Long b, @Param("inforTitle") String inforTitle, @Param("inforStatus") Integer inforStatus, @Param("founder") String founder, @Param("sendBeginTime") Long sendBeginTime, @Param("sendEndTime") Long sendEndTime);
    ...
    List<Object> selectInforByReadListAll(@Param("b") Long b);
    List<Object> selectContent(@Param("id") Long id);
    Long selectCount();
    Long selectCountWithCondition( @Param("inforTitle") String inforTitle,Integer inforStatus,String founder,Long sendBeginTime,Long sendEndTime);
