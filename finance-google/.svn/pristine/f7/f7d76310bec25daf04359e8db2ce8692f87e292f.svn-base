...
public class HistoryProducts {
    ...
    public HistoryProducts(String product, String bankCard, String buyer, Long buyTime, Long arriveTime, Integer transactionAction, BigDecimal transactionAmouont, String phone) {
