...
//        logger.info(informationManages.toString());
    ...
    public JSONObject addInformation(String inforTitle, String inforPicture, String inforContent,
                                     Long sendTime, Integer inforStatus,HttpServletRequest request) throws IOException {
//        logger.info("/a/u/information---POST---the request parameters are inforTitle:{},inforContent:{},sendTime:{},inforStatus:{}",inforTitle,inforContent,sendTime,inforStatus);
    ...
    public JSONObject updateInformation(Long id,String inforTitle,String inforPicture,
                                        String inforContent,Long sendTime,Integer inforStatus,HttpServletRequest request) throws IOException {
