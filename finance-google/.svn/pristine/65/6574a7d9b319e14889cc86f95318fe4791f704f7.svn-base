...
public class ProBindServlet extends HttpServlet implements APIBaseServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			String messagecode = req.getParameter("messagecode");
			...
			beanReq.setMsgCode(messagecode);
			
			//beanReq.setProtocolNo(protocolno);
			beanReq.setSign(getSign(beanReq.proBindSignStr(key), "MD5", privatekey));
			
			//String url = "http://192.168.8.29:29024/mobile_pay/cardPro/unbindAction.pay";
			String url = ConfigReader.getString("api.protocolbind_3.0_url");
