...
public interface ObligatoryRightMapper {
    ...
    List<ObligatoryRight> select(@Param("a") Long a, @Param("b") Long b, @Param("id") Long id, @Param("company") String company, @Param("corporate") String corporate, @Param("status") Integer status);
