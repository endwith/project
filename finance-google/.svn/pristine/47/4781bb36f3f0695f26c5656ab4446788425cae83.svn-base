...
public class Trade implements Serializable {
    ...
    public Trade(Long investmentContractId, String product, String purchaser, Long buyTime, Long delayTime, Long expireTime, BigDecimal toBeMatched, BigDecimal purchaseAmount,  Integer status, Long userId, BigDecimal expectedRate) {
        this.investmentContractId = investmentContractId;
