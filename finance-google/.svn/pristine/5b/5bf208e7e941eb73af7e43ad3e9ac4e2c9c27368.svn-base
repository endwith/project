...
import com.ptteng.fuiou.api.data.APIProPayXmlBeanReq;
...
public class PayProServlet extends HttpServlet implements APIBaseServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			APIProPayXmlBeanReq beanReq =new APIProPayXmlBeanReq();
			...
			//String url = "http://192.168.8.29:29024/mobile_pay/apipropay/payAction.pay";
			String url = ConfigReader.getString("api.propay_3.0_url");
