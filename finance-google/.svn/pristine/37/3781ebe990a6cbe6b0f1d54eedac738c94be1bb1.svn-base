...
public class InformationManage implements Serializable {
    private Long id;
    ...
    public InformationManage(String inforId, String inforTitle, String founder, Long createAt, String modifier, Long updateAt, Integer inforStatus, Long sendTime, String inforContent, String inforPicture) {
