...
public class ProductController {
    ...
    public JSONObject addProduct( String productName, BigDecimal expectedRate,
                                 ...
                                 String introduce, String moreInformation ,HttpServletRequest request ){
        return productService.addProduct( productName, expectedRate, investmentCycle, originMoney, addMoney,
                returnInterest, introduce, moreInformation,request);
    }
    /**
     *66产品编辑—获取该产品信息
     */
    ...
    public JSONObject updateProduct(Long id,String productName,BigDecimal expectedRate,Integer investmenCycle,
                                    ...
                                    String introduce,String moreInformation,Integer status,HttpServletRequest request){
        return productService.updateProduct(id, productName, expectedRate, investmenCycle,
                originMoney, addMoney, returnInterest, introduce, moreInformation, status,request);
    }
    /**
     *69产品删除
     */
